...
static void event_handler_cb_setup_obj17(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 115, 0, e);
    }
}
...
static void event_handler_cb_preset_obj18(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_preset_obj19(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_reset_preset_obj20(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_reset_preset_obj21(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_game_obj39(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_game_obj40(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_game_clear_cooldowns(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_mission_empty(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_mission_obj41(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_config_chb_debug_1(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_config_wifi_password_input(lv_event_t *e) {
    ...
    if (event == LV_EVENT_DEFOCUSED) {
        e->user_data = (void *)0;
        action_hide_keyboard(e);
    }
    if (event == LV_EVENT_FOCUSED) {
        e->user_data = (void *)0;
        action_show_keyboard(e);
    }
}
...
static void event_handler_cb_config_connect(lv_event_t *e) {
    ...
    if (event == LV_EVENT_PRESSED) {
        e->user_data = (void *)0;
        action_action_wifi_connect_selected(e);
    }
}
...
static void event_handler_cb_config_connect__manual_(lv_event_t *e) {
    ...
    if (event == LV_EVENT_PRESSED) {
        e->user_data = (void *)0;
        action_action_wifi_connect_manual(e);
    }
}
...
static void event_handler_cb_config_btn_rollback(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_config_obj48(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 83, 0, e);
    }
}
...
static void event_handler_cb_config_obj50(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 86, 0, e);
    }
}
...
static void event_handler_cb_reset_config_obj52(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_about_obj54(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_manual_obj55(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
void create_screen_setup() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        {
            // lbl_current_version_setup
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.lbl_current_version_setup = obj;
            lv_obj_set_pos(obj, 1, 394);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
...
void create_screen_preset() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_preset_obj18, LV_EVENT_ALL, flowState);
            add_style_button_std(obj);
        ...
        }
        {
            ...
            lv_obj_set_style_align(obj, LV_ALIGN_BOTTOM_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 0, 0);
                    lv_obj_set_size(obj, 76, LV_PCT(100));
                    lv_obj_add_event_cb(obj, event_handler_cb_preset_obj19, LV_EVENT_ALL, flowState);
                    add_style_button_std(obj);
                    lv_obj_set_style_bg_img_src(obj, &img_icon_clear, LV_PART_MAIN | LV_STATE_DEFAULT);
                }
            }
        ...
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_flex_flow(obj, LV_FLEX_FLOW_ROW_WRAP, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 0, 0);
                    lv_obj_set_size(obj, 76, 38);
                    lv_obj_add_event_cb(obj, event_handler_cb_reset_preset_obj20, LV_EVENT_ALL, flowState);
                    add_style_button_std(obj);
                    lv_obj_set_style_border_color(obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 0, 0);
                    lv_obj_set_size(obj, 76, 38);
                    lv_obj_add_event_cb(obj, event_handler_cb_reset_preset_obj21, LV_EVENT_ALL, flowState);
                    add_style_button_std(obj);
                    lv_obj_set_style_border_color(obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][4]), LV_PART_MAIN | LV_STATE_DEFAULT);
...
void create_screen_image() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, LV_PCT(90), 421);
            lv_obj_set_style_pad_left(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_top(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_right(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_bottom(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void create_screen_game() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_game_obj39, LV_EVENT_ALL, flowState);
            add_style_button_std(obj);
            lv_obj_set_style_align(obj, LV_ALIGN_BOTTOM_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_pos(obj, 2, -2);
            lv_obj_set_size(obj, 76, 38);
            lv_obj_add_event_cb(obj, event_handler_cb_game_obj40, LV_EVENT_ALL, flowState);
            add_style_button_std(obj);
            lv_obj_set_style_align(obj, LV_ALIGN_BOTTOM_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_img_src(obj, &img_icon_back, LV_PART_MAIN | LV_STATE_DEFAULT);
        }
        ...
        }
        {
            // ClearCooldowns
            lv_obj_t *obj = lv_btn_create(parent_obj);
            objects.clear_cooldowns = obj;
            lv_obj_set_pos(obj, 94, 375);
            lv_obj_set_size(obj, 76, 38);
            lv_obj_add_event_cb(obj, event_handler_cb_game_clear_cooldowns, LV_EVENT_ALL, flowState);
            add_style_button_std(obj);
            lv_obj_set_style_border_color(obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][4]), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_size(obj, 69, 33);
                    lv_obj_set_style_text_font(obj, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_label_set_text(obj, "Clear Cooldowns");
                }
            }
        }
    }
...
void create_screen_mission() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
                ...
                }
                {
                    ...
                    lv_obj_set_style_pad_column(obj, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_set_pos(obj, 997, 1140);
                            lv_obj_set_size(obj, 100, 100);
                            lv_obj_add_event_cb(obj, event_handler_cb_mission_empty, LV_EVENT_ALL, flowState);
                            lv_obj_add_flag(obj, LV_OBJ_FLAG_HIDDEN);
                            add_style_button_std(obj);
                            lv_obj_set_style_bg_img_src(obj, &img_cc1, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_border_color(obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][5]), LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_pos(obj, -2, -2);
            lv_obj_set_size(obj, 76, 38);
            lv_obj_add_event_cb(obj, event_handler_cb_mission_obj41, LV_EVENT_ALL, flowState);
            add_style_button_std(obj);
            lv_obj_set_style_align(obj, LV_ALIGN_BOTTOM_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_img_src(obj, &img_icon_back, LV_PART_MAIN | LV_STATE_DEFAULT);
        }
...
void create_screen_config() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, LV_PCT(100), 440);
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_style_flex_flow(obj, LV_FLEX_FLOW_ROW_WRAP, LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                                    ...
                                    lv_obj_set_pos(obj, 0, 0);
                                    lv_obj_set_size(obj, LV_PCT(100), LV_SIZE_CONTENT);
                                    lv_label_set_text(obj, "Enable Debug");
                                }
                                {
                                    // ChbDebug_1
                                    lv_obj_t *obj = lv_switch_create(parent_obj);
                                    objects.chb_debug_1 = obj;
                                    lv_obj_set_pos(obj, 0, 0);
                                    lv_obj_set_size(obj, 64, 32);
                                    lv_obj_add_event_cb(obj, event_handler_cb_config_chb_debug_1, LV_EVENT_ALL, flowState);
                                    add_style_checkbox_config(obj);
                                }
                            }
                        }
                        ...
                        }
                        {
                            ...
                            lv_obj_set_style_flex_flow(obj, LV_FLEX_FLOW_ROW_WRAP, LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                ...
                                }
                                {
                                    lv_obj_t *obj = lv_obj_create(parent_obj);
                                    lv_obj_set_pos(obj, 0, 0);
                                    lv_obj_set_size(obj, LV_PCT(100), 346);
                                    lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                                    lv_obj_set_style_pad_top(obj, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
                                    lv_obj_set_style_pad_bottom(obj, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
                                    lv_obj_set_style_pad_left(obj, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
                                    ...
                                    lv_obj_set_style_clip_corner(obj, true, LV_PART_MAIN | LV_STATE_DEFAULT);
                                    {
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_pos(obj, 0, 0);
                                            lv_obj_set_size(obj, LV_PCT(100), LV_SIZE_CONTENT);
                                            lv_checkbox_set_text(obj, "Zero-G Breech Loading");
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_pos(obj, 0, 0);
                                            lv_obj_set_size(obj, LV_PCT(100), LV_SIZE_CONTENT);
                                            lv_checkbox_set_text(obj, "Liquid-Ventilated Cockpit");
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_pos(obj, 0, 0);
                                            lv_obj_set_size(obj, LV_PCT(100), LV_SIZE_CONTENT);
                                            lv_checkbox_set_text(obj, "Synthetic Supplementation");
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_pos(obj, 0, 0);
                                            lv_obj_set_size(obj, LV_PCT(100), LV_SIZE_CONTENT);
                                            lv_checkbox_set_text(obj, "Targeting Software Upgrade");
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_pos(obj, 0, 0);
                                            lv_obj_set_size(obj, LV_PCT(100), LV_SIZE_CONTENT);
                                            lv_checkbox_set_text(obj, "Dynamic Tracking");
                                ...
                                }
                                {
                                    ...
                                    lv_obj_add_flag(obj, LV_OBJ_FLAG_FLOATING);
                                    {
                                        lv_obj_t *parent_obj = obj;
                                        {
                                            ...
                                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                                            lv_label_set_text(obj, "Scan SSID");
                                        }
                                    }
                                }
                                {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_style_flex_flow(obj, LV_FLEX_FLOW_ROW_WRAP, LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                                    // Manual_status_label
                                    lv_obj_t *obj = lv_label_create(parent_obj);
                                    objects.manual_status_label = obj;
                                ...
                                }
                                {
                                    ...
                                    lv_obj_add_event_cb(obj, event_handler_cb_config_connect__manual_, LV_EVENT_ALL, flowState);
                                    {
                                        lv_obj_t *parent_obj = obj;
                                        {
                                            ...
                                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                                            lv_label_set_text(obj, "Manual Connect");
                                        }
                                    }
                                }
                            }
                ...
                }
                {
                    ...
                    add_style_tab_config(obj);
                    {
                        ...
                        {
                            // lbl_previous_version
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            objects.lbl_previous_version = obj;
                            lv_obj_set_pos(obj, -515, 546);
        ...
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_flex_flow(obj, LV_FLEX_FLOW_ROW_WRAP, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 0, 0);
                    lv_obj_set_size(obj, 76, 38);
                    lv_obj_add_event_cb(obj, event_handler_cb_reset_config_obj52, LV_EVENT_ALL, flowState);
                    add_style_button_std(obj);
                    lv_obj_set_style_border_color(obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_src(obj, &img_icon_yes, LV_PART_MAIN | LV_STATE_DEFAULT);
                }
...
void create_screen_about() {
    ...
    lv_obj_set_style_bg_img_opa(obj, 31, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_pos(obj, 2, -2);
            lv_obj_set_size(obj, 76, 38);
            lv_obj_add_event_cb(obj, event_handler_cb_about_obj54, LV_EVENT_ALL, flowState);
            add_style_button_std(obj);
            lv_obj_set_style_bg_img_src(obj, &img_icon_back, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_align(obj, LV_ALIGN_BOTTOM_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
        }
...
void create_screen_manual() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_pos(obj, 2, -2);
            lv_obj_set_size(obj, 76, 38);
            lv_obj_add_event_cb(obj, event_handler_cb_manual_obj55, LV_EVENT_ALL, flowState);
            add_style_button_std(obj);
            lv_obj_set_style_align(obj, LV_ALIGN_BOTTOM_LEFT, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_bg_img_src(obj, &img_icon_back, LV_PART_MAIN | LV_STATE_DEFAULT);
        }
...
void change_color_theme(uint32_t theme_index) {
    ...
    lv_style_set_text_color(get_style_checkbox_config2_INDICATOR_CHECKED(), lv_color_hex(theme_colors[theme_index][1]));
    ...
    lv_obj_set_style_border_color(objects.obj20, lv_color_hex(theme_colors[theme_index][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
    
    lv_obj_set_style_border_color(objects.obj21, lv_color_hex(theme_colors[theme_index][4]), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(objects.clear_cooldowns, lv_color_hex(theme_colors[theme_index][4]), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(objects.empty, lv_color_hex(theme_colors[theme_index][5]), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_color(objects.obj53, lv_color_hex(theme_colors[theme_index][4]), LV_PART_MAIN | LV_STATE_DEFAULT);
