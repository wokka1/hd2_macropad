...
//
// Style: CheckboxConfig2
//

void init_style_checkbox_config2_INDICATOR_DEFAULT(lv_style_t *style) {
    lv_style_set_border_width(style, 0);
    lv_style_set_bg_color(style, lv_color_hex(0xff000000));
};

lv_style_t *get_style_checkbox_config2_INDICATOR_DEFAULT() {
    static lv_style_t *style;
    if (!style) {
        style = lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_checkbox_config2_INDICATOR_DEFAULT(style);
    }
    return style;
};

void init_style_checkbox_config2_INDICATOR_CHECKED(lv_style_t *style) {
    lv_style_set_border_width(style, 0);
    lv_style_set_text_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][1]));
    lv_style_set_bg_color(style, lv_color_hex(0xff000000));
};

lv_style_t *get_style_checkbox_config2_INDICATOR_CHECKED() {
    static lv_style_t *style;
    if (!style) {
        style = lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_checkbox_config2_INDICATOR_CHECKED(style);
    }
    return style;
};

void add_style_checkbox_config2(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_checkbox_config2_INDICATOR_DEFAULT(), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_checkbox_config2_INDICATOR_CHECKED(), LV_PART_INDICATOR | LV_STATE_CHECKED);
};

void remove_style_checkbox_config2(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_checkbox_config2_INDICATOR_DEFAULT(), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_checkbox_config2_INDICATOR_CHECKED(), LV_PART_INDICATOR | LV_STATE_CHECKED);
};
...
void init_style_tab_config2_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_pad_top(style, 8);
    lv_style_set_pad_bottom(style, 8);
    lv_style_set_pad_left(style, 0);
    lv_style_set_pad_right(style, 0);
...
lv_style_t *get_style_tab_config2_MAIN_DEFAULT() {
    static lv_style_t *style;
    if (!style) {
        style = lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_tab_config2_MAIN_DEFAULT(style);
    }
    return style;
};

void add_style_tab_config2(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_tab_config2_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

void remove_style_tab_config2(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_tab_config2_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};
...
void add_style(lv_obj_t *obj, int32_t styleIndex) {
    ...
    static const AddStyleFunc add_style_funcs[] = {
        ...
        add_style_checkbox_config2,
        add_style_switch_config,
        add_style_tab_config2,
    };
...
void remove_style(lv_obj_t *obj, int32_t styleIndex) {
    ...
    static const RemoveStyleFunc remove_style_funcs[] = {
        ...
        remove_style_checkbox_config2,
        remove_style_switch_config,
        remove_style_tab_config2,
    };
